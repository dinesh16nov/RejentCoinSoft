                                    ...
                                    <div class="card-body" style="padding-bottom: 5px; padding-top: 5px;">
                                        ...
                                        <div class="row">
                                            <div class="col text-center b-r-light" style="font-size: 13px;">
                                                <span>Balance</span>
                                                <h4> $
                                                    <span  class="mb-0" style="font-size: 18px;font-weight: 600;color:black">  <asp:Label ID="lblbalanceamount2" runat="server" Text="0"></asp:Label></span>
                                                  </h4>
                                            </div>
                ...
                <div class="widget-joins card widget-arrow">
                  <div class="row">
                      ...
                      <div class="media border-after-xs">
                        <div class="align-self-center me-3 text-start"><span class="widget-t mb-1">Direct</span>
                        ...
                        <div class="media-body">
                          <h5 class="mb-0">$<span class="">
                                       <asp:Label ID="lbldirectbusiness" runat="server" Text="0"></asp:Label></span></h5><%--<span class="mb-1">-$2658(36%)</span>--%>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 ps-0">
                      <div class="media">
                        <div class="align-self-center me-3 text-start"><span class="widget-t mb-1">Sponser</span>
                          <h5 class="mb-0">Business</h5>
                        </div>
                        <div class="media-body align-self-center"><i class="font-primary" data-feather="arrow-up"></i></div>
                        <div class="media-body ps-2">
                          <h5 class="mb-0">$<span class=""> <asp:Label ID="lblsponserbusiness" runat="server" Text="0"></asp:Label></span></h5><%--<span class="mb-1">+$369(15%)</span>--%>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 pe-0">
                      <div class="media border-after-xs">
                        ...
                        <div class="media-body">
                          <h5 class="mb-0">$<span class="">
                                       <asp:Label ID="lblleftbusiness" runat="server" Text="0"></asp:Label></span></h5><%--<span class="mb-1">-$2658(36%)</span>--%>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 ps-0">
                      <div class="media">
                        ...
                        <div class="media-body align-self-center"><i class="font-primary" data-feather="arrow-up"></i></div>
                        <div class="media-body ps-2">
                          <h5 class="mb-0">$<span class=""> <asp:Label ID="lblrightbusiness" runat="server" Text="0"></asp:Label></span></h5><%--<span class="mb-1">+$369(15%)</span>--%>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 pe-0">
                      <div class="media border-after-xs">
                        ...
                        <div class="media-body align-self-center"><i class="font-primary" data-feather="arrow-up"></i></div>
                        <div class="media-body">
                          <h5 class="mb-0">$<span class=""> <asp:Label ID="lblselfbusiness" runat="server" Text="0"></asp:Label></span></h5><%--<span class="mb-1">+$69(65%)</span>--%>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-6 ps-0">
                      <div class="media">
                        ...
                        <div class="media-body ps-2">
                          <h5 class="mb-0">$<span class=""> <asp:Label ID="lbltotalbusienss" runat="server" Text="0"></asp:Label></span></h5>
                        </div>
                      </div>
                    </div>
                  </div>
