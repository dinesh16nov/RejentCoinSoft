<%@ Page Title="Add Country" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="MasterBonanza.aspx.cs" Inherits="admin_CountryAdd" %>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row form-group">
                <div class="col-md-2">
                    <label class="control-label">Bonanza Name</label>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <asp:TextBox ID="txtstartdate" CssClass="form-control datepicker-here" runat="server"></asp:TextBox>
                </div>
                 <div class="col-md-2">
                    <label class="control-label">End Date</label>
                </div>
                <div class="col-md-2">
                    <asp:TextBox ID="txtendDate" CssClass="form-control datepicker-here" runat="server"></asp:TextBox>
                </div>
    ...
    <script type="text/javascript">
        ...
        function validate() {
            if (document.getElementById("<%=txtcountryname.ClientID%>").value == "") {
                toastr.warning('Warning', 'Enter Bonanza Name');      // 
                //alert("Enter Rank No");
